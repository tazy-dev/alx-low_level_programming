...
In this project, I practiced  singly linked lists in C , how to create , define and use them.
Also the differences between it and array and  when and why to use it.
